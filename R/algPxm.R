            ...
            for (j in 1:(i - minI + 1)) {
                ...
                if (mthNme == "binAnD" || mthNme == "binDsp" || mthNme == "binKc2" || mthNme == "binLmb" || mthNme == "binOch" || mthNme == "binPh4" || mthNme == "binPtD" || 
                    ...
                    if (mthNme == "binAnD" || mthNme == "binLmb") {
                        ...
                        t2 = max(sum(mtcVec[1], mtcVec[3], na.rm = TRUE), sum(mtcVec[2], mtcVec[4], na.rm = TRUE), na.rm = TRUE) +
                             max(sum(mtcVec[1], mtcVec[2], na.rm = TRUE), sum(mtcVec[3], mtcVec[4], na.rm = TRUE), na.rm = TRUE)
                    }
                }
